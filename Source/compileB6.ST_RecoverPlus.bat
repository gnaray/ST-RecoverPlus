...
"%BCB%\bin\bcc32.exe" %BCC_OPTIONS% -c -I"%BCB%\Include";"%BCB%\Include\vcl" -L"%BCB%\lib" ST_RecoverPlus.cpp GUIForm1.cpp AccessDiskThread.cpp AnalyseDiskThread.cpp FloppyDisk.cpp Track.cpp FdrawcmdSys.cpp vcl.bpi
