call BCBconfig.bat
"%BCB%\bin\bcc32.exe" %BCC_OPTIONS% -c -I"%BCB%\Include";"%BCB%\Include\vcl" -L"%BCB%\lib" ST_Recover.cpp Unit1.cpp Acces_disque.cpp Analyse_disque.cpp Classe_Disquette.cpp Classe_Piste.cpp vcl.bpi
